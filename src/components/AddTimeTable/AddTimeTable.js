...
class AddTimeTable extends PureComponent
{
  ...
  renderDay(cellInfo)
  {
    ...
    return (
      ...
      <div style={{ backgroundColor: '#fafafa', padding: "50px 0"}}>{this.state.data[cellInfo.index][cellInfo.column.id]}</div>
  ...
  render()
  {
    ...
    if (!(this.state.completeteTT && this.state.teachers && this.state.subjects))
    {
